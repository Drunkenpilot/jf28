...
INSERT INTO `admin_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES ('fc0a8cf9fb2708d487f8005651b6ab6c', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.152 Safari/537.36', 1395496436, 'a:2:{s:9:"user_data";s:0:"";s:8:"admin_id";i:1;}');
UNLOCK TABLES;
